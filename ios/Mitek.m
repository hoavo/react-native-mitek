...
@implementation Mitek

RCT_EXPORT_MODULE(Mitek)
...
- (void)startSnapFlow
{
    dispatch_async(dispatch_get_main_queue(), ^{
        self.selectedDocumentTypeIndex = [[[NSUserDefaults standardUserDefaults] objectForKey:@"misnap.documentType"] integerValue];
