...
/*!
 ...
 @abstract invoked whenever an exception is thrown in and caught by MiSnapBarcodeScanner
 
 @discussion It might be important to client apps to be notified when an exception occurs in MiSnapBarcodeScanner
 so that an appropriate action can be taken
 
 This is invoked for kMiSnapDocumentTypePDF417 and all capture modes.
 
 @param exception that was thrown by MiSnapBarcodeScanner.
 
 */
- (void)miSnapBarcodeDidCatchException:(NSException *)exception;
