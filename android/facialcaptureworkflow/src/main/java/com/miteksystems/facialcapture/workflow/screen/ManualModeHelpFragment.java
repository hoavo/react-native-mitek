 ...
 */
public class ManualModeHelpFragment extends Fragment {

    private static final String TAG = ManualModeHelpFragment.class.getSimpleName();

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.facialcapture_fragment_manual_mode_help, container, false);

        Button buttonProcess = (Button) rootView.findViewById(R.id.manual_mode_help_process);
    ...
    public void onResume() {
        super.onResume();
        EventBus.getDefault().post(new TextToSpeechEvent(R.string.facialcapture_manual_mode_help_tts, FacialCaptureWorkflowParameters.getTTSDelayMS()));
    }
}
